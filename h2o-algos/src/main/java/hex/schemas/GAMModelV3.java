...
public class GAMModelV3 extends ModelSchemaV3<GAMModel, GAMModelV3, GAMModel.GAMParameters, GAMV3.GAMParametersV3,
  ...
  public static final class GAMModelOutputV3 extends ModelOutputSchemaV3<GAMModel.GAMModelOutput, GAMModelOutputV3> {
    ...
    @API(help="Table of Standardized Coefficients")
    TwoDimTableV3 standardized_coefficients_table;
    
    @API(help="Table of Standardized Coefficients without centering")
    TwoDimTableV3 standardized_coefficients_table_no_centering;
    ...
    String _gamTransformedTrainCenterKey;
  }
