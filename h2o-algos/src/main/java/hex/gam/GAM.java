  ...
  //      model._output._model_summary_GAM = createModelSummaryTable(model._output, true);
    ...
    private void copyGLMtoGAMModel(GAMModel model, GLMModel glmModel) {
      ...
      if (_parms._family == multinomial || _parms._family == ordinal) {
        model._output._coefficients_table = model.genCoefficientTableMultinomial(new String[]{"coefficient name",
                        "coefficient value"}, model._output._model_beta_multinomial,
                model._output._coefficient_names, false,
                "GAM Coefficients");
        model._output._standardized_coefficients_table = model.genCoefficientTableMultinomial(new String[]{"coefficient name",
                        "coefficient value"}, model._output._standardized_model_beta_multinomial, 
                model._output._coefficient_names, true,
                "Standardized GAM Coefficients");
        model._output._coefficients_table_no_centering = model.genCoefficientTableMultinomial(new String[]{"coefficient name no centering",
                        "coefficient value no centering"}, model._output._model_beta_multinomial_no_centering,
                model._output._coefficient_names_no_centering, false,
                "GAM Coefficients No Centering");
        model._output._standardized_coefficients_table_no_centering = model.genCoefficientTableMultinomial(new String[]{"coefficient name no centering",
                        "coefficient value no centering"}, model._output._standardized_model_beta_multinomial_no_centering,
                model._output._coefficient_names_no_centering, true,
                "Standardized GAM Coefficients No Centering");
      } else{
        model._output._coefficients_table = model.genCoefficientTable(new String[]{"coefficient name",
                        "coefficient value no centering"}, model._output._model_beta,
                model._output._coefficient_names, false,
                "GAM Coefficients");
        model._output._standardized_coefficients_table = model.genCoefficientTable(new String[]{"coefficient name",
                        "coefficient value"}, model._output._standardized_model_beta,
                model._output._coefficient_names, true,
                "Standardized GAM Coefficients");
        model._output._coefficients_table_no_centering = model.genCoefficientTable(new String[]{"coefficient name no centering",
                        "coefficient value no centering"}, model._output._model_beta_no_centering,
                model._output._coefficient_names_no_centering, false,
                "GAM Coefficients No Centering");
        model._output._standardized_coefficients_table_no_centering = model.genCoefficientTable(new String[]{"coefficient name no centering",
                        "coefficient value no centering"}, model._output._standardized_model_beta_no_centering,
                model._output._coefficient_names_no_centering, true,
                "Standardized GAM Coefficients No Centering");
      }
              
      //model._output._standardized_coefficients_table = 
      //model._output._standardized_coefficient_magnitudes
